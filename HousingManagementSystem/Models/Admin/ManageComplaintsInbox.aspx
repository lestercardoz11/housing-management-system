<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageComplaintsInbox.aspx.cs" Inherits="HousingManagementSystem.Models.ManageComplaintsInbox" %>
                    ...
                    <div style="padding: 15px;">
                        ...
                        <asp:Panel ID="PanelDiv" runat="server" Height="100%">
                            <div style="z-index: 20; padding: 20px;">
                                <h3 style="text-align: center">You have no complaints.</h3>
                            </div>
                        </asp:Panel>
                        <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSourceComplaint" OnItemCommand="ListView1_ItemCommand" OnDataBound="ListView1_DataBound" OnItemDataBound="ListView1_ItemDataBound" DataKeyNames="CpID">
                            <ItemTemplate>
                                <asp:Panel ID="panelComplaint" CssClass="panelHover" runat="server" Style="width: auto; overflow: hidden">
                                    <div class="flexWrapper" style="width: 100%; height: auto; border-bottom: 1px solid #808080">
                                        ...
                                        <div style="width: 20%; height: inherit; display: inline-flex; padding: 10px;">
                                            <asp:Label ID="lblFName" runat="server" Text='<%# Eval("FName") %>' CssClass="Label" Font-Size="Large" Style="margin: 0px 2.5px"></asp:Label>
                                            <asp:Label ID="lblLName" runat="server" Text='<%# Eval("LName") %>' CssClass="Label" Font-Size="Large" Style="margin: 0px 2.5px"></asp:Label>
                                        </div>
                                        <div class="flexWrapper" style="width: 60%; height: inherit; padding: 10px;">
                                            <div style="height: inherit; width: 100%; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                                ...
                                                <div id="Reply" runat="server" style="width: auto; height: auto; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                        ...
                                        <div style="width: 6%; height: inherit; padding: 10px;">
                                            <asp:Button ID="BReply" runat="server" Text="Reply" CssClass="Button" Width="100%" Font-Size="Medium" CommandArgument='<%#Eval("CpID")%>' CommandName="Reply" Style="border-radius: 1px" />
                                        </div>
                                    </div>
                                </asp:Panel>
                            </ItemTemplate>
