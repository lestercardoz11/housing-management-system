<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MChangePassword.aspx.cs" Inherits="HousingManagementSystem.Models.Member.ChangePassword" %>
    ...
    <form id="form1" runat="server">
                    ...
                    <asp:Panel ID="PAccount" runat="server" CssClass="shadow" Style="width: auto; padding: 5px; margin-top: 10px; border-radius: 3px; background-color: white">
                        <asp:Menu ID="MAccount" runat="server" BackColor="White" DynamicHorizontalOffset="0" Font-Size="Medium" ForeColor="#3B6D76" StaticSubMenuIndent="0px" Width="100%" OnMenuItemClick="MAccount_MenuItemClick">
                            ...
                            <Items>
                                ...
                                <asp:MenuItem Text="Change Password" Value="Change Password" NavigateUrl="~/Models/Member/MChangePassword.aspx" Selected="true"></asp:MenuItem>
        ...
        <div id="Main">
            ...
            <div class="sub1 shadow" style="border-radius: 10px;">
                ...
                <br />
                <br />
                <div class="login2" style="width: 100%; text-align: center">
                    <asp:Button ID="BSubmit" runat="server" Text="Update" Font-Size="Large" CssClass="Button" Width="15%" Style="margin: 0px 20px" OnClick="BSubmit_Click" />
                    <asp:Button ID="BClear" runat="server" Text="Clear" Font-Size="Large" CssClass="Button" BackColor="#EEEEEE" ForeColor="#353736" Width="15%" Style="margin: 0px 20px" OnClick="BClear_Click" />
                </div>
            </div>
        </div>
        <br />
