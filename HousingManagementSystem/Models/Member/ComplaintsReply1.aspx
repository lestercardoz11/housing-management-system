<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComplaintsReply1.aspx.cs" Inherits="HousingManagementSystem.Models.Member.ComplaintsReply1" %>
            ...
            <div class="MainMenu">
                <div class="leftMenu" style="min-height: 100vh">
                    ...
                    <asp:Menu ID="MenuSociety" runat="server" BackColor="#3B6D76" DynamicHorizontalOffset="0" Font-Names="Verdana" Width="100%" Font-Size="Large" ForeColor="White" StaticSubMenuIndent="10px" DynamicEnableDefaultPopOutImage="False" StaticEnableDefaultPopOutImage="False">
                        ...
                        <Items>
                            <asp:MenuItem Text="MAKE A COMPLAINT" Value="MAKE A COMPLAINT" NavigateUrl="~/Models/Member/Complaints.aspx"></asp:MenuItem>
                    ...
                    <div style="padding: 15px;">
                        <asp:Panel ID="Panel1" runat="server" Style="padding: 15px; border: 1px solid #808080; width: auto">
                            ...
                            <div style="padding: 10px">
                                <asp:Label ID="LabelName" runat="server" Text="" Font-Size="X-Large" ForeColor="#494949"></asp:Label>
                            ...
                            <br />
                            <div>
                                <asp:Label ID="LabelReplyDate" runat="server" Text="" Font-Size="Medium" ForeColor="#808080" Style="float: right"></asp:Label>
                            </div>
                            <br />
                            <br />
