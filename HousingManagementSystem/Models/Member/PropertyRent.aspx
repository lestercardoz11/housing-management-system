<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PropertyRent.aspx.cs" Inherits="HousingManagementSystem.Models.Member.PropertyRent" %>
                ...
                <div class="rightMain" style="width: 60%; min-height: 100vh">
                    <div style="border: 1px solid #335252; padding: 10px; margin: 10px;">
                        ...
                        <div class="buttonWrapper" style="text-align: initial; width: auto">
                            <asp:Button ID="BRent" runat="server" Text="Rent" CssClass="Button" OnClick="BRent_Click" Style="border-radius: 1px" />
                        </div>
                    </div>
                </div>
                <div class="leftMenu" style="min-height: 100vh">
