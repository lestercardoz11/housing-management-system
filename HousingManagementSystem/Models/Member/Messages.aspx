<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Messages.aspx.cs" Inherits="HousingManagementSystem.Models.Member.Messages" %>
            ...
            <div class="MainMenu">
                ...
                <div class="rightMain" style="min-height: 100vh">
                    <div style="padding: 15px;">
                        ...
                        <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSourceMessage" OnItemCommand="ListView1_ItemCommand" OnDataBound="ListView1_DataBound" DataKeyNames="MID">
                            <ItemTemplate>
                                <asp:Panel ID="panelMessages" CssClass="panelHover" runat="server" Style="width: auto; overflow: hidden">
                                    <div class="flexWrapper" style="width: 100%; height: auto; border-bottom: 1px solid #808080">
                                        ...
                                        <div style="width: 20%; height: inherit; display: inline-flex; padding: 10px;">
                                            <asp:Label ID="lblFName" runat="server" Text='<%# Eval("FullName") %>' CssClass="Label" Font-Size="Large" Style="margin: 0px 2.5px"></asp:Label>
                                        </div>
                                        <div class="flexWrapper" style="width: 60%; height: inherit; padding: 10px;">
                                            <div style="height: inherit; width: 100%; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                                <div style="width: auto;">
                                                    <asp:Label ID="lblSubjectName" runat="server" Text='<%# Eval("ApartmentNo") %>' CssClass="Label" Font-Size="Large" Style="margin: 0px 2.5px"></asp:Label>
                                                </div>
                                        ...
                                        <div style="width: 6%; height: inherit; padding: 10px;">
                                            <asp:Button ID="BReply" runat="server" Text="View" CssClass="Button" Width="100%" Font-Size="Medium" CommandArgument='<%#Eval("MID")%>' CommandName="View" Style="border-radius: 1px" />
                                        </div>
                                    </div>
                                </asp:Panel>
                            </ItemTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceMessage" runat="server" ConnectionString="<%$ ConnectionStrings:HousingMSdbConnectionString %>" SelectCommand="SELECT Users.UID AS Expr7, House.HID AS Expr5, House.UID AS Expr6, House.ApartmentNo, Message.* FROM Message INNER JOIN Users ON Message.UID = Users.UID INNER JOIN House ON Message.HID = House.HID AND Users.UID = House.UID WHERE (Message.UID = @UID) ORDER BY Message.EntryDate DESC" OnSelecting="SqlDataSourceMessage_Selecting">
                            <SelectParameters>
