<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForSale.aspx.cs" Inherits="HousingManagementSystem.Models.ForSale" %>
                ...
                <div id="Login">
                    ...
                    <asp:Menu ID="MenuBar" runat="server" BackColor="#45E4E7" DynamicHorizontalOffset="0" Width="100%" Font-Size="20px" ForeColor="#FFFFFF" Orientation="Horizontal" StaticSubMenuIndent="10px" DynamicEnableDefaultPopOutImage="False" StaticEnableDefaultPopOutImage="False" Height="30px" Font-Bold="True">
                        ...
                        <Items>
                            ...
                            <asp:MenuItem Text="FOR SALE" Value="FOR SALE" NavigateUrl="~/Models/Home/ForSale.aspx" Selected="true"></asp:MenuItem>
            ...
            <div class="MainMenu">
                ...
                <div class="rightMain" style="width: 70%; min-height: 100vh">
                    <div style="padding: 15px;">
                        <h1 style="color: #494949; font-size: larger; border-bottom:1px solid #494949; padding: 10px 0px">FOR SALE</h1>
                        <br />
                        ...
                        <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSourceSale" OnItemCommand="ListView1_ItemCommand" OnDataBound="ListView1_DataBound" OnItemDataBound="ListView1_ItemDataBound" DataKeyNames="HID">
                            <ItemTemplate>
                                        ...
                                        <div style="padding-left: 10px">
                                            ...
                                            <div class="flexWrapper" style="padding: 10px 10px">
                                                ...
                                                <div class="buttonWrapper" style="text-align: right; width: auto">
                                                    <asp:Button ID="BSale" runat="server" Text="Enquire" CssClass="Button" CommandArgument='<%#Eval("HID")+","+ Eval("UID") +","+ Eval("ApartmentNo")%>' CommandName="Enquire" Style="background-color: inherit; color: #ff0000; border: 2px solid #ff0000; border-radius: 3px;" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceSale" runat="server" ConnectionString="<%$ ConnectionStrings:HousingMSdbConnectionString %>" SelectCommand="SELECT Sell.*, House.*, Society.*, Users.* FROM Sell INNER JOIN House ON Sell.HID = House.HID INNER JOIN Society ON Sell.SID = Society.SID AND House.SID = Society.SID INNER JOIN Users ON Sell.UID = Users.UID AND House.UID = Users.UID ORDER BY Sell.EntryDate DESC"></asp:SqlDataSource>
                    </div>
                </div>
                <div class="leftMenu" style="min-height: 100vh; width: 15%;">
                </div>
